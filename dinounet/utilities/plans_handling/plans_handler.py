...
from dinounet.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
import dinounet
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from dinounet.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from dinounet.utilities.find_class_by_name import recursive_find_python_class
from dinounet.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    from dinounet.utilities.label_handling.label_handling import LabelManager
    from dinounet.imageio.base_reader_writer import BaseReaderWriter
    from dinounet.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
    from dinounet.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(dinounet.__path__[0], "preprocessing"),
                                                         self.preprocessor_name,
                                                         current_module="dinounet.preprocessing")
...
class PlansManager(object):
    ...
    def experiment_planner_class(self) -> Type[ExperimentPlanner]:
        ...
        experiment_planner = recursive_find_python_class(join(dinounet.__path__[0], "experiment_planning"),
                                                         planner_name,
                                                         current_module="dinounet.experiment_planning")
