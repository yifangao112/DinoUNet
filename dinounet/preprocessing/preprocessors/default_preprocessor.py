...
from dinounet.paths import nnUNet_preprocessed, nnUNet_raw
from dinounet.preprocessing.cropping.cropping import crop_to_nonzero
from dinounet.preprocessing.resampling.default_resampling import compute_new_shape
...
from dinounet.utilities.utils import get_identifiers_from_splitted_dataset_folder, \
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(dinounet.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'dinounet.preprocessing.normalization')
