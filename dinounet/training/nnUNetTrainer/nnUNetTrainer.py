...
from dinounet.configuration import ANISO_THRESHOLD, default_num_processes
from dinounet.evaluation.evaluate_predictions import compute_metrics_on_folder
from dinounet.inference.export_prediction import export_prediction_from_logits, resample_and_save
from dinounet.inference.predict_from_raw_data import nnUNetPredictor
from dinounet.inference.sliding_window_prediction import compute_gaussian
from dinounet.paths import nnUNet_preprocessed, nnUNet_results
from dinounet.training.data_augmentation.compute_initial_patch_size import get_patch_size
from dinounet.training.data_augmentation.custom_transforms.cascade_transforms import MoveSegAsOneHotToData, \
    ApplyRandomBinaryOperatorTransform, RemoveRandomConnectedComponentFromOneHotEncodingTransform
from dinounet.training.data_augmentation.custom_transforms.deep_supervision_donwsampling import \
    DownsampleSegForDSTransform2
from dinounet.training.data_augmentation.custom_transforms.limited_length_multithreaded_augmenter import \
    LimitedLenWrapper
from dinounet.training.data_augmentation.custom_transforms.masking import MaskTransform
from dinounet.training.data_augmentation.custom_transforms.region_based_training import \
    ConvertSegmentationToRegionsTransform
from dinounet.training.data_augmentation.custom_transforms.transforms_for_dummy_2d import Convert2DTo3DTransform, \
    Convert3DTo2DTransform
from dinounet.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from dinounet.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from dinounet.training.dataloading.nnunet_dataset import nnUNetDataset
from dinounet.training.dataloading.utils import get_case_identifiers, unpack_dataset
from dinounet.training.logging.nnunet_logger import nnUNetLogger
from dinounet.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from dinounet.training.loss.deep_supervision import DeepSupervisionWrapper
from dinounet.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from dinounet.training.lr_scheduler.polylr import PolyLRScheduler
from dinounet.utilities.collate_outputs import collate_outputs
from dinounet.utilities.crossval_split import generate_crossval_split
from dinounet.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from dinounet.utilities.file_path_utilities import check_workers_alive_and_busy
from dinounet.utilities.get_network_from_plans import get_network_from_plans
from dinounet.utilities.helpers import empty_cache, dummy_context
from dinounet.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from dinounet.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.output_folder_base = join(nnUNet_results, self.plans_manager.dataset_name,
                                       ...
                                       self.__class__.__name__ + '__' + plans_identifier + "__" + configuration) \
        ...
        self.folder_with_segs_from_previous_stage = \
            join(nnUNet_results, self.plans_manager.dataset_name,
                 ...
                 self.__class__.__name__ + '__' + plans_identifier + "__" +
    ...
    def configure_optimizers(self):
        ...
        # lr_scheduler = PolyLRScheduler(optimizer, self.initial_lr, 100000)
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        '''
        tp_list = outputs_collated['tp_hard']
        fp_list = outputs_collated['fp_hard']
        fn_list = outputs_collated['fn_hard']

        dice_list = []
        for idx, x in enumerate(tp_list):
            dice_list.append(2 * tp_list[idx] / (2 * tp_list[idx] + fp_list[idx] + fn_list[idx]))
        '''
        if self.is_ddp:
            world_size = dist.get_world_size()
        ...
        # mean_fg_dice = np.mean(dice_list)
        # global_dc_per_class = [mean_fg_dice]
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        if self.local_rank == 0:
            self.print_to_log_file(self.plans_manager.image_reader_writer_class(),
                                                self.dataset_json["file_ending"],
                                                self.label_manager.foreground_regions if self.label_manager.has_regions else
                                                self.label_manager.foreground_labels,
                                                self.label_manager.ignore_label, also_print_to_console=True)
    ...
    def run_training(self):
        ...
        for epoch in range(self.current_epoch, self.num_epochs):
            ...
            with torch.no_grad():
                ...
                # for batch_id in tqdm(range(len(self.dataloader_val))):
