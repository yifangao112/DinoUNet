...
from dinounet.training.dataloading.utils import unpack_dataset
import math
from dinounet.training.dataloading.utils import get_case_identifiers
...
class nnUNetDatasetNumpy(nnUNetBaseDataset):
    ...
    def unpack_dataset(folder: str, overwrite_existing: bool = False,
                       num_processes: int = default_num_processes,
                       verify: bool = True):
        return unpack_dataset(folder, overwrite_existing, num_processes, verify)
